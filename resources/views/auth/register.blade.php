<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <button id="register" name="register" type="submit" class="inline-flex items-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-4">{{ __('Зарегистрировать') }}</button>
        </div>
    </form>
</x-guest-layout>
