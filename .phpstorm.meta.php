...
'components.input-error','components.input-error-auth','components.input-label','components.modal','components.nav-link',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.select','components.text-input',
'components.textarea','index','layouts.app','layouts.guest','layouts.navigation',
...
'task.edit','task.form','task.index','task.show','task_status.create',
'task_status.edit','task_status.form','task_status.index','flash::message','flash::modal',
...
'validation.custom.attribute-name.rule-name','views.task_status.index.list','controllers.task_status.index','controllers.task_status.create','controllers.task_status.store',
'controllers.task_status.show','controllers.task_status.edit','controllers.task_status.update','controllers.task_status.destroy','controllers.task_status.flash.destroy_success',
'controllers.task_status.flash.destroy_error','controllers.task_status.flash.store_success','controllers.task_status.flash.update_success','controllers.task.index','controllers.task.create',
'controllers.task.store','controllers.task.show','controllers.task.edit','controllers.task.update','controllers.task.destroy',
'controllers.task.flash.destroy_success','controllers.task.flash.destroy_error','controllers.task.flash.destroy_auth_error','controllers.task.flash.store_success','controllers.task.flash.update_success',
'layouts.navigation.task_status','layouts.navigation.task','layouts.navigation.home','layouts.navigation.buttons.logout','layouts.navigation.buttons.login',
...
'models.task.created_at','validation.task_status.name.unique','views.index.header','views.index.description','views.task_status.index.actions',
'views.task_status.index.confirm_deletion','views.task.index.actions','views.task.index.confirm_deletion',);
