...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/loth/php-project-57/public/storage' => 'string',
            ...
            'logging.channels.rollbar.driver' => 'string',
            'logging.channels.rollbar.handler' => 'string',
            'logging.channels.rollbar.access_token' => 'string',
            'logging.channels.rollbar.level' => 'string',
            'mail.default' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/loth/php-project-57/public/storage','logging.default',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.rollbar.driver','logging.channels.rollbar.handler',
'logging.channels.rollbar.access_token','logging.channels.rollbar.level','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme',
...
'session.same_site','session.partitioned','query-builder.parameters.include','query-builder.parameters.filter','query-builder.parameters.sort',
...
'sanctum.csrf-cookie','main','profile.edit','profile.update',
'profile.destroy','task_status.index','task_status.create','task_status.store','task_status.show',
'task_status.edit','task_status.update','task_status.destroy','tasks.index','tasks.create',
'tasks.store','tasks.show','tasks.edit','tasks.update','tasks.destroy',
'labels.index','labels.create','labels.store','labels.show','labels.edit',
'labels.update','labels.destroy','register','login','password.request','password.email','password.reset','password.store',
...
'auth.verify-email','components.a-btn-primary','components.auth-session-status','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-error-auth','components.input-label','components.modal',
...
'components.text-input','components.textarea','index','label.create','label.edit',
'label.form','label.index','layouts.app','layouts.guest','layouts.navigation',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','task.create',
'task.edit','task.filter','task.form','task.index','task.show',
'task_status.create','task_status.edit','task_status.form','task_status.index','flash::message',
'flash::modal','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'validation.custom.attribute-name.rule-name','views.task_status.index.list','flash.task_status.destroy_success','flash.task_status.destroy_error','flash.task_status.store_success',
'flash.task_status.update_success','flash.task.destroy_success','flash.task.destroy_error','flash.task.destroy_auth_error','flash.task.store_success',
'flash.task.update_success','flash.label.destroy_success','flash.label.destroy_error','flash.label.store_success','flash.label.update_success',
'layouts.navigation.task_status','layouts.navigation.task','layouts.navigation.label','layouts.navigation.home','layouts.navigation.buttons.logout',
'layouts.navigation.buttons.login','layouts.navigation.buttons.register','models.task_status.id','models.task_status.name','models.task_status.created_at',
'models.task.id','models.task.name','models.task.description','models.task.author','models.task.responsible',
'models.task.status','models.task.labels','models.task.created_at','models.label.id','models.label.name',
'models.label.description','validation.task_status.name.unique','validation.label.name.unique','views.common.actions.title','views.common.actions.actions.delete',
'views.common.actions.actions.edit','views.index.title','views.index.content','views.task_status.index.title','views.task_status.index.confirm_deletion',
'views.task_status.index.buttons.create','views.task_status.create.title','views.task_status.create.buttons.create','views.task_status.edit.title','views.task_status.edit.buttons.edit',
'views.task.index.title','views.task.index.confirm_deletion','views.task.index.buttons.create','views.task.index.buttons.filter','views.task.show.title',
'views.task.create.title','views.task.create.buttons.create','views.task.edit.title','views.task.edit.buttons.edit','views.label.index.title',
'views.label.index.confirm_deletion','views.label.index.buttons.create','views.label.create.title','views.label.create.buttons.create','views.label.edit.title',
'views.label.edit.buttons.edit',);
...
'DB_USERNAME','DB_PASSWORD','DB_URL','SESSION_DRIVER','SESSION_LIFETIME',
