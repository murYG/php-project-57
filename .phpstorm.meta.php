...
'task_status.edit','task_status.update','task_status.destroy','register',
...
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','index',
'layouts.app','layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','task_status.create','task_status.edit','task_status.form',
'task_status.index','flash::message','flash::modal','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'controllers.task_status.flash.destroy_error','controllers.task_status.flash.store_success','controllers.task_status.flash.update_success','layouts.navigation.task_status','layouts.navigation.home',
'layouts.navigation.buttons.logout','layouts.navigation.buttons.login','layouts.navigation.buttons.register','models.task_status.id','models.task_status.name',
'models.task_status.created_at','validation.task_status.name.required','validation.task_status.name.unique','views.index.header','views.index.description',
'views.task_status.index.actions','views.task_status.index.confirm_deletion',);
