...
'validation.attributes.password','validation.task_status.name.unique','validation.label.name.unique','views.common.actions.title','views.common.actions.actions.delete',
