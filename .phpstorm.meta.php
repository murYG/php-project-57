...
'validation.task_status.name.unique','validation.label.name.unique','views.common.actions.title','views.common.actions.actions.delete','views.common.actions.actions.edit',
'views.index.title','views.index.content','views.task_status.index.title','views.task_status.index.confirm_deletion','views.task_status.index.buttons.create',
