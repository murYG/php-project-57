...
'components.text-input','components.textarea','label.create','label.edit','label.form',
'label.index','layouts.app','layouts.guest','layouts.navigation','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','task.create','task.edit',
'task.filter','task.form','task.index','task.show','task_status.create',
'task_status.edit','task_status.form','task_status.index','welcome','flash::message',
...
'validation.custom.attribute-name.rule-name','flash.task_status.destroy_success','flash.task_status.destroy_error','flash.task_status.store_success','flash.task_status.update_success',
'flash.task.destroy_success','flash.task.destroy_error','flash.task.destroy_auth_error','flash.task.store_success','flash.task.update_success',
'flash.label.destroy_success','flash.label.destroy_error','flash.label.store_success','flash.label.update_success','layouts.navigation.task_status',
'layouts.navigation.task','layouts.navigation.label','layouts.navigation.home','layouts.navigation.buttons.logout','layouts.navigation.buttons.login',
'layouts.navigation.buttons.register','models.task_status.id','models.task_status.name','models.task_status.created_at','models.task.id',
'models.task.name','models.task.description','models.task.author','models.task.responsible','models.task.status',
'models.task.labels','models.task.created_at','models.label.id','models.label.name','models.label.description',
'models.label.created_at','validation.attributes.password','validation.task_status.name.unique','validation.label.name.unique','views.common.actions.title',
'views.common.actions.actions.delete','views.common.actions.actions.edit','views.index.title','views.index.content','views.task_status.index.title',
'views.task_status.index.confirm_deletion','views.task_status.index.buttons.create','views.task_status.create.title','views.task_status.create.buttons.create','views.task_status.edit.title',
'views.task_status.edit.buttons.edit','views.task.index.title','views.task.index.confirm_deletion','views.task.index.buttons.create','views.task.index.buttons.filter',
'views.task.show.title','views.task.create.title','views.task.create.buttons.create','views.task.edit.title','views.task.edit.buttons.edit',
'views.label.index.title','views.label.index.confirm_deletion','views.label.index.buttons.create','views.label.create.title','views.label.create.buttons.create',
'views.label.edit.title','views.label.edit.buttons.edit',);
